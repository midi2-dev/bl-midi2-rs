...
mod tests {
    ...
    fn builder() {
        assert_eq!(
            ProgramChangeMessage::builder(&mut Ump::random_buffer::<4>())
                .group(u4::new(0xF))
                .channel(u4::new(0xE))
                .program(u7::new(0x75))
                .bank(Some(u14::new(0x1F5E)))
                .build(),
            Ok(ProgramChangeMessage(&[0x4FCE_0001, 0x7500_5E3E, 0x0, 0x0])),
        );
    }
    ...
    fn builder_no_bank() {
        assert_eq!(
            ProgramChangeMessage::builder(&mut Ump::random_buffer::<4>())
                ...
                .program(u7::new(0x75))
                .build(),
            Ok(ProgramChangeMessage(&[0x4FCE_0000, 0x7500_0000, 0x0, 0x0])),
        );
    }
