...
impl<B: crate::buffer::Ump> crate::util::property::Property<B> for ConsistentStatuses {
    type Type = ();
}

impl<'a, B: crate::buffer::Ump> crate::util::property::ReadProperty<'a, B> for ConsistentStatuses {
...
impl<B: crate::buffer::Ump> crate::util::property::Property<B> for ValidPacketSizes {
    type Type = ();
}

impl<'a, B: crate::buffer::Ump> crate::util::property::ReadProperty<'a, B> for ValidPacketSizes {
    fn read(_buffer: &'a B) -> Self::Type {
        ()
    }
    fn validate(buffer: &B) -> crate::result::Result<()> {
...
impl<'a, B: crate::buffer::Ump> crate::util::property::ReadProperty<'a, B> for GroupProperty {
...
impl<B: crate::buffer::Ump> crate::util::property::Property<B> for StreamIdProperty {
    type Type = u8;
}

impl<'a, B: crate::buffer::Ump> crate::util::property::ReadProperty<'a, B> for StreamIdProperty {
    fn read(buffer: &'a B) -> Self::Type {
        use crate::buffer::UmpPrivate;
...
mod tests {
    ...
    fn try_from_slice_inconsistent_groups() {
        assert_eq!(
            ...
            Err(crate::error::Error::InvalidData(
                crate::message::helpers::ERR_INCONSISTENT_GROUPS
            )),
        );
    }
    ...
    fn try_from_slice_expected_start() {
        assert_eq!(
            ...
            Err(crate::error::Error::InvalidData(
                crate::message::helpers::ERR_SYSEX_EXPECTED_BEGIN
            )),
        );
    }
    ...
    fn try_from_slice_expected_continue() {
        assert_eq!(
            ...
            Err(crate::error::Error::InvalidData(
                crate::message::helpers::ERR_SYSEX_EXPECTED_CONTINUE
            )),
        );
    }
    ...
    fn try_from_slice_expected_end() {
        assert_eq!(
            ...
            Err(crate::error::Error::InvalidData(
                crate::message::helpers::ERR_SYSEX_EXPECTED_END
            )),
        );
    }
    ...
    fn try_from_slice_expected_complete() {
        assert_eq!(
            ...
            Err(crate::error::Error::InvalidData(
                crate::message::helpers::ERR_SYSEX_EXPECTED_COMPLETE
            )),
        );
    }
