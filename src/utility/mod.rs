...
impl<B: crate::buffer::Buffer> crate::detail::property::Property<B> for JitterReductionProperty {
...
impl<B: crate::buffer::Ump> crate::detail::property::Property<B> for TypeProperty {
    type Type = ();
}

impl<'a, B: crate::buffer::Ump> crate::detail::property::ReadProperty<'a, B> for TypeProperty {
    fn read(_buffer: &'a B) -> Self::Type {
        ()
    }
    fn validate(buffer: &B) -> crate::result::Result<()> {
        use crate::detail::BitOps;
        if buffer.buffer()[0].nibble(0) != crate::ux::u4::new(0x0) {
    ...
    for TypeProperty
{
    fn write(buffer: &mut B, _v: Self::Type) {
        use crate::detail::BitOps;
        buffer.buffer_mut()[0].set_nibble(0, crate::ux::u4::new(0x0));
    }
...
impl<const STATUS: u8, B: crate::buffer::Ump> crate::detail::property::Property<B>
    for StatusProperty<STATUS>
{
    type Type = ();
}

impl<'a, const STATUS: u8, B: crate::buffer::Ump> crate::detail::property::ReadProperty<'a, B>
    for StatusProperty<STATUS>
{
    fn read(_buffer: &'a B) -> Self::Type {
        ()
...
impl<const STATUS: u8, B: crate::buffer::Ump + crate::buffer::BufferMut>
    crate::detail::property::WriteProperty<B> for StatusProperty<STATUS>
{
    fn write(buffer: &mut B, _v: Self::Type) {
        use crate::detail::BitOps;
        buffer.buffer_mut()[0].set_nibble(2, crate::ux::u4::new(STATUS));
    }
    fn validate(_v: &Self::Type) -> crate::result::Result<()> {
        Ok(())
    }
